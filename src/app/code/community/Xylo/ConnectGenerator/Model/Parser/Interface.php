...
/**
 * Configuration files parser interface
 *
 ...
 */
interface Xylo_ConnectGenerator_Model_Parser_Interface {

    /**
     * Parses provided config and returns as instance of Varien_Object
     *
     * @param  mixed $config
